  ...
  return (
    <div className="min-h-[80vh] container mx-auto">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-8">
        <div className="bg-[#111B2D] border border-[#FFFFFF20] lg:p-10 p-6 rounded-2xl">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 lg:gap-10 gap-5">
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={html} alt="html" />
              Html5
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={css} alt="css" />
              Css3
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={js} alt="Js" />
              Javascript
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="h-12 w-auto" src={tailwind} alt="tailwind" />
              Tailwind
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={bootstrap} alt="bootstrap" />
              Bootstrap
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={atom} alt="atom" />
              React
            </div>
          </div>
        </div>
        <div className="bg-[#111B2D] border border-[#FFFFFF20] lg:p-10 p-5 rounded-2xl">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 lg:gap-10 gap-5">
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={node} alt="Node js" />
              Node JS
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={express} alt="Express js" />
              Express JS
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="h-12 w-auto" src={jwt} alt="Json Web Token" />
              Jwt
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={firebase} alt="Firebase" />
              Firebase
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={next} alt="next" />
              Next JS
            </div>
          </div>
        </div>
        <div className="bg-[#111B2D] border border-[#FFFFFF20] lg:p-10 p-5 rounded-2xl">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 lg:gap-10 gap-5">
            ...
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={netlify} alt="Netlify" />
              Netlify
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="h-12 w-auto" src={vscode} alt="Vs Code" />
              VS Code
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={figma} alt="Firebase" />
              Figma
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={devtools} alt="atom" />
              Devtools
            </div>
          </div>
        </div>
        <div className="bg-[#111B2D] border border-[#FFFFFF20] lg:p-10 p-5 rounded-2xl">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 lg:gap-10 gap-5">
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image className="w-auto h-14" src={mongodb} alt="Mongodb" />
              Mongodb
            </div>
            <div className="flex gap-3 items-center bg-[#111B2D] border border-[#FFFFFF20] p-4 justify-center rounded-3xl">
              <Image
