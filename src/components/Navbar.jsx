...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-3 w-full z-40">
      <div className="navbar container mx-auto py-0 lg:px-6 md:rounded-full md:border border-[#242C36] glassmorphism shadow-none">
        ...
        <div className="navbar-end gap-5 items-center">
          ...
          <Link
            href={"/contact"}
            className="btn btn-neutral bg-[#111B2D] rounded-full px-6 font-normal text-base text-primary min-h-6 h-12 hidden lg:flex"
          >
            Contact Us
          </Link>
        </div>
